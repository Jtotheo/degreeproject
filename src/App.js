...
function App() {
  ...
  return (
    ...
    <Router>
      ...
      <Route exact path="/categories/sthlm/akt2" component= {user ? MDSthlm : About} />
      <Route exact path="/categories/sthlm/akt3" component= {user ? BFSthlm : About} />
      <Route exact path="/categories/sthlm/akt4" component= {user ? KNSthlm : About} />
      <Route exact path="/categories/sthlm/akt5" component= {user ? OvrigtSthlm : About} />

      <Route exact path="/categories/gbg" component= {user ? CategoryGridGTBG : About} />
      <Route exact path="/categories/gbg/akt" component= {user ? THGtbg : About} />
      <Route exact path="/categories/gbg/akt1" component= {user ? NFGtbg : About} />
      <Route exact path="/categories/gbg/akt2" component= {user ? MDGtbg : About} />
      <Route exact path="/categories/gbg/akt3" component= {user ? BFGtbg : About} />
      <Route exact path="/categories/gbg/akt4" component= {user ? KNGtbg : About} />
      <Route exact path="/categories/gbg/akt5" component= {user ? OvrigtGtbg : About} />

      <Route exact path="/categories/mlmo" component= {user ? CategoryGridMLMO : About} />
      <Route exact path="/categories/mlmo/akt" component= {user ? THMlmo : About} />
      <Route exact path="/categories/mlmo/akt1" component= {user ? NFMlmo : About} />
      <Route exact path="/categories/mlmo/akt2" component= {user ? MDMlmo : About} />
